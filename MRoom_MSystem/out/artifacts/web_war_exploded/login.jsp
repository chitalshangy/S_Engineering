...
<script type="text/javascript" src="${path}/static/layui/layui.all.js"/>
<script type="text/javascript" src="${path}/static/js/login.js"/>
<script type="text/javascript" src="${path}/static/js/jparticle.jquery.js"/>
</body>
</html>
