    ...
    <form class="layui-form layui-form-pane" onsubmit="return false" id="booktype">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" id="aid" name="aid" value="<%=request.getAttribute("id")%>" readonly><br>
            </div>
            <label class="layui-form-label"> 密码</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input" id="apassword" name="apassword" value="<%=request.getAttribute("password")%>"><br>
            </div>
