    ...
    <form class="layui-form" action="addReserve.action" method="post" onsubmit="return validateDate()">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="reserve.rid" lay-verify="required">
                    <option value=""></option>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="reserve.title" required lay-verify="required" placeholder="请输入"
                       autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" id="stime" name="reserve.startTime" required
                       lay-verify="required"
                       placeholder="请输入">
            </div>
        </div>
...
<div class="right" style="width:49%;float:right;">
    ...
    <script type="text/javascript">
        ...
        $.get('graReserveList.action', function (rawData) {
            _rawData = rawData;
